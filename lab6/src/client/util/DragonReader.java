...
public class DragonReader {
    ...
    public String readNameKiller() {
        String nameKiller;
        while (true) {
            IOUtils.print("Введите имя убийцы этого дракона: ");
    ...
    public String readPassportId() {
        String passport;
        while (true) {
            IOUtils.print("Введите номер паспорта убийцы: ");
    ...
    public Color readHairColor() {
        ...
        while (true) {
            try {
                IOUtils.print("Введите цвет волос убийцы дракона из списка( ");
    ...
    public Country readNationality() {
        ...
        while (true) {
            try {
                IOUtils.print("Введите страну убийцы дракона из списка( ");
    ...
    public double readLocationX() {
        ...
        while (true) {
            try {
                IOUtils.print("Введите координату Х убийцы: ");
                String str = IOUtils.input();
    ...
    public int readLocationY() {
        ...
        while (true) {
            try {
                IOUtils.print("Введите координату Y убийцы: ");
                String str = IOUtils.input();
                y = Integer.parseInt(str.trim());
                return y;
            } catch (NumberFormatException e) {
                IOUtils.printErr("Координата Y не может быть не числом!");
            }
        }
    }
    ...
    public String readLocationName() {
        String locationName;
        while (true) {
            IOUtils.print("Введите название гильдии убийцы: ");
